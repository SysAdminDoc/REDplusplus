...
```
curl -Lo RED++.zip https://github.com/SysAdminDoc/REDplusplus/releases/latest/download/RED++_v1.5.15.zip
tar -xf RED++.zip
RED+.exe
```
...
```
gh attestation verify RED++_v1.5.15.zip -R SysAdminDoc/REDplusplus
```
